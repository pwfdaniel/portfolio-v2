        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
              ...
              <Column fillWidth gap="l" marginBottom="48">
                {about.work.experiences.map((experience, index) => (
                  <Column
                    ...
                    fillWidth
                    marginTop={index === 0 ? undefined : "48"}
                  >
                    ...
                    {experience.tools && experience.tools.length > 0 && (
                      <Row wrap gap="8" paddingTop="16" paddingLeft="4">
                        {experience.tools.map((toolId) => {
                          const meta = toolLookup[toolId];
                          if (!meta) return null;
                          return (
                            <Tag
                              key={`${experience.company}-tool-${toolId}`}
                              size="l"
                              style={{
          ...
          {about.technical.display && (
            <>
              ...
              >
                {about.technical.skills.map(({ title, src }) => (
                  <Column
                    as="div"
                    key={title}
                    gap="8"
                  ...
                  >
                    <SkillIcon
                      title={title}
                      src={src || "/images/icons/react.png"}
                    />
                    <Text
                      as="span"
                      variant="body-default-m"
